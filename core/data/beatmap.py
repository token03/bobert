...
GENRE_NAMES = [
    'unspecified', 'video_game', 'anime', 'rock', 'pop',
    'other', 'novelty', 'hip_hop', 'electronic', 'metal',
    'classical', 'folk', 'jazz'
]

LANGUAGE_NAMES = [
    'english', 'chinese', 'french', 'german', 'italian',
    'japanese', 'korean', 'spanish', 'swedish', 'russian',
    'polish', 'other', 'instrumental', 'unspecified'
]
...
BPM_CATEGORIES = [
    '0-59', '60-79', '80-99', '100-119', '120-139',
    '140-159', '160-179', '180-199', '200-219', '220-239',
    '240-259', '260-279', '280-299', '300+'
]

STATUS_CATEGORIES = [
    # we treat pending and wip as graveyard
    # we also treat qualified as ranked
    'graveyard', 'ranked', 'approved', 'loved' 
]
